...
## Physics Algorithm
The physics algorithm used in this system was very important to create the smooth projectile drop motion. I learnt the algorithm off a DevForum post and translated it into Luau. How it works: (If you're interested in the DevForum post, links wil be shown below!)
 ```
